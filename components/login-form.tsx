        ...
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center mb-4">
                ...
                <p className="text-balance text-muted-foreground">
                  Login to your MyBookmarks account
                </p>
              </div>
          ...
          <div className="relative hidden bg-zinc-950 md:block">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/80 to-transparent flex flex-col justify-end p-10">
              <h2 className="text-white text-2xl font-bold mb-2">Elevate Your Reading</h2>
              <p className="text-zinc-400 text-sm max-w-[280px]">
                Join thousands of users organizing their digital world with intelligence and style.
              </p>
            </div>
          </div>
        </CardContent>
